...
export const metadata: Metadata = {
  title: "LoanPulse - Microfinance Loan Management System",
  description: "Smart microfinance loan management with AI-powered risk assessment and real-time monitoring",
};
